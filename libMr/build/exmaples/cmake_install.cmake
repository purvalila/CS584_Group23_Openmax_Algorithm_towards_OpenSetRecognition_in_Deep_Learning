# Install script for directory: /home/pragati-home/OSDN_CIFAR/libMR/examples
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/pragati-home/OSDN_CIFAR/libMR/build/examples/mr-test")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/mr-test" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mr-test")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/mr-test"
         OLD_RPATH "/home/pragati-home/OSDN_CIFAR/libMR/build/libMR:"
         NEW_RPATH "")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/pragati-home/OSDN_CIFAR/libMR/build/examples/wbl-test")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/wbl-test" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/wbl-test")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/wbl-test"
